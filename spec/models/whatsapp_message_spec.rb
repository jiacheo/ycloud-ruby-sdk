...
# Unit tests for YCloudApiClient::WhatsappMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YCloudApiClient::WhatsappMessage do
  let(:instance) { YCloudApiClient::WhatsappMessage.new }

  describe 'test an instance of WhatsappMessage' do
    it 'should create an instance of WhatsappMessage' do
      expect(instance).to be_instance_of(YCloudApiClient::WhatsappMessage)
    end
  end
