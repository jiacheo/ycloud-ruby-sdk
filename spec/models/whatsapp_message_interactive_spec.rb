...
# Unit tests for YCloudApiClient::WhatsappMessageInteractive
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YCloudApiClient::WhatsappMessageInteractive do
  let(:instance) { YCloudApiClient::WhatsappMessageInteractive.new }

  describe 'test an instance of WhatsappMessageInteractive' do
    it 'should create an instance of WhatsappMessageInteractive' do
      expect(instance).to be_instance_of(YCloudApiClient::WhatsappMessageInteractive)
    end
  end
