...
# Unit tests for YCloudApiClient::Email
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YCloudApiClient::Email do
  let(:instance) { YCloudApiClient::Email.new }

  describe 'test an instance of Email' do
    it 'should create an instance of Email' do
      expect(instance).to be_instance_of(YCloudApiClient::Email)
    end
  end
