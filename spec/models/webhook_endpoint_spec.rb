...
# Unit tests for YCloudApiClient::WebhookEndpoint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YCloudApiClient::WebhookEndpoint do
  let(:instance) { YCloudApiClient::WebhookEndpoint.new }

  describe 'test an instance of WebhookEndpoint' do
    it 'should create an instance of WebhookEndpoint' do
      expect(instance).to be_instance_of(YCloudApiClient::WebhookEndpoint)
    end
  end
