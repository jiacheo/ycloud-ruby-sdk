...
# Unit tests for OpenapiClient::WebhookEndpoint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookEndpoint do
  let(:instance) { OpenapiClient::WebhookEndpoint.new }

  describe 'test an instance of WebhookEndpoint' do
    it 'should create an instance of WebhookEndpoint' do
      expect(instance).to be_instance_of(OpenapiClient::WebhookEndpoint)
    end
  end
