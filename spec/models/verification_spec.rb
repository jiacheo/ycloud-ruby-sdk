...
# Unit tests for YCloudApiClient::Verification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YCloudApiClient::Verification do
  let(:instance) { YCloudApiClient::Verification.new }

  describe 'test an instance of Verification' do
    it 'should create an instance of Verification' do
      expect(instance).to be_instance_of(YCloudApiClient::Verification)
    end
  end
