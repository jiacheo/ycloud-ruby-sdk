...
# Unit tests for YCloudApiClient::Page
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YCloudApiClient::Page do
  let(:instance) { YCloudApiClient::Page.new }

  describe 'test an instance of Page' do
    it 'should create an instance of Page' do
      expect(instance).to be_instance_of(YCloudApiClient::Page)
    end
  end
